...
namespace BLL.Services
{
    public class ManagerService
    {
        ...
        {
            var data = DataAccessFactory.ManagerData().Get(id);
            var mapper = MapperService<Manager, ManagerDTO>.GetMapper();
        ...
        public static bool Create(ManagerDTO Manager)
        {
            ...
            return DataAccessFactory.ManagerData().Create(mapped);
        ...
        public static bool Delete(int id)
        {
            ...
            return DataAccessFactory.IssueData().Delete(id);
        ...
        public static BookingNotificationDTO ReceiveBookingNotification(int client, string name)
        {
            ...
            var addedBookingNotification = DataAccessFactory.BookingNotificationData().Create(bookingNotification);
        ...
        public static PaymentNotificationDTO ReceivePaymentNotification(int id, string name)
        {
            ...
            var addedPaymentNotification = DataAccessFactory.PaymentNotificationData().Create(paymentNotification);
        ...
        public static IssueNotificationDTO ReceiveIssueNotification(int id, string name)
        {
            ...
            var addedIssueNotification = DataAccessFactory.IssueNotificationData().Create(issueNotification);
